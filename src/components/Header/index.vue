  ...
  data() {
    ...
    return {
      menu: [
        ...
        { path: '/archive', display: archiveOpts.display, icon: 'inbox', title: '总和' },
        ...
        { path: '/tag', display: tagOpts.display, icon: 'tag', title: '标签' },
		    { path: '/movies', display: bookOpts.display, icon: 'pencil', title: '影视' },
        { path: '/inspiration', display: inspirationOpts.display, icon: 'comment', title: '语录' },
